...
![alt-text-1](https://github.com/epfl-lasa/ML_toolbox/blob/master/img/csvm_optimal_visual.png =100x20)![alt-text-2](https://github.com/epfl-lasa/ML_toolbox/blob/master/img/ada_50_iterations_alpha.png){:height="36px" width="36px"}
